            ...
            <div className="w-full animate-in fade-in zoom-in-95 duration-300">
              ...
              <form onSubmit={handleSend} className="space-y-4">
                <input 
                  ...
                  className="w-full h-16 bg-white border-2 border-slate-200 focus:border-blue-500 focus:bg-white focus:ring-8 focus:ring-blue-500/5 transition-all rounded-2xl text-[17px] md:text-xl font-bold px-6 text-center placeholder:text-slate-300 placeholder:font-bold outline-none"
                  required
                  autoFocus
                />
